...
${RUN} --java-opts=${JAVA_OPT} --launcher-class=io.vertx.core.Launcher --redeploy=./src/main/js/dataaccess/eventbus/server.js ./src/main/js/dataaccess/eventbus/server.js
